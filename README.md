...
**Article Summary:**  
The article explains why agent evaluation is harder than traditional LLM evaluation, introduces the survey’s 2D taxonomy of evaluation objectives and processes, and highlights real-world challenges such as safety, reliability, compliance, memory, and planning. It includes my own analysis, insights, and visuals for better understanding.
...
## 📘 4. Paper Summary (Short Version)

The short story and materials are based on the survey’s key contributions:

### 🔹 1. Evaluation Objectives — WHAT to measure
...
### 🔹 2. Evaluation Process — HOW to evaluate
...
## 🔍 5. Additional Survey Papers Referenced (Optional)
